export default function CompanyCard({src, title, description}: {src: string, title: string, description: string}) {
  return (
    <div className="flex flex-col items-center grow shrink basis-0 justify-evenly bg-white border rounded-lg shadow-md md:flex-row md:max-w-xl dark:border-gray-700 dark:bg-gray-800">
